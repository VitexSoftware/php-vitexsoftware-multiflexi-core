...
{
    public function testPrepareJobRollsBackOwnedTransactionWhenPreparationFails(): void
    {
        ...
        $job->expects($this->never())->method('deleteFromSQL');
    ...
    public function testPrepareJobDeletesCreatedJobInsideOuterTransactionWhenPreparationFails(): void
    {
        $application = $this->createMock(Application::class);
        $company = $this->createMock(Company::class);
